...
SUM(PR.COL12) AS COL12,
SUM(PR.COL13) AS COL13,
SUM(PR.COL14) AS COL14,
SUM(PR.COL15) AS COL15,
SUM(PR.COL16) AS COL16,
SUM(PR.COL17) AS COL17,
SUM(PR.COL18) AS COL18,
SUM(PR.COL19) AS COL19,
SUM(PR.COL20) AS COL20,
SUM(PR.COL21) AS COL21,
SUM(PR.COL22) AS COL22

FROM
USER_EREPORTING.VW_DATA_ALL_PRIMIT PR --M1, CONS.TS, 5CI,65 AUTO, 2 INVEST
INNER JOIN CIS.RENIM R ON R.CUIIO = PR.CUIIO AND R.CUIIO_VERS = PR.CUIIO_VERS
    INNER JOIN CIS.MD_FORM F ON (PR.FORM=F.FORM AND PR.FORM_VERS=F.FORM_VERS)
...
WHERE
PR.PERIOADA = :pPERIOADA 
 --AND D.DATA_REG  < TO_DATE('04/01/2026 00:00:00', 'MM/DD/YYYY HH24:MI:SS') 
 AND 
--D.CUATM LIKE '01%' AND

PR.ID_SCHEMA IN (1) AND 
PR.FORM IN (:pFORM)
