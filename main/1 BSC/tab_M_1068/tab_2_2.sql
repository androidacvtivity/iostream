...
SELECT
  ...
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1017) THEN (DD.R000_3) ELSE NULL END),1) AS COL2,
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1017) THEN (DD.R999_3) ELSE NULL END),1) AS COL3,
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1017) THEN (DD.R000_4) ELSE NULL END),1) AS COL4,
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1017) THEN (DD.R999_4) ELSE NULL END),1) AS COL5
