...
SELECT
  ...
  A.ORDINE,
  A.RIND,
  A.COL1 *100 / (A.COL1 + A.COL2 + A.COL3) AS COL1,
  A.COL2 *100 / (A.COL1 + A.COL2 + A.COL3) AS COL2,
  A.COL3 *100 / (A.COL1 + A.COL2 + A.COL3) AS COL3,
  NULL AS COL4,
  NULL AS COL5
FROM
(
...
WHERE
  ...
  CIS2.X_BAZA_SONDAJ BS ON (A.CUIIO=BS.CUIIO AND BS.ANUL=2026)                             --'B+C+D+E+F+G+H+I+J+L+M+N+R+S'
  CROSS JOIN 
  (
