...
--  D.ID_MD_D,
  ...
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1018) THEN DD.R240_1 ELSE NULL END),1) AS COL2,
  ROUND(SUM(CASE WHEN DD.CAPITOL IN (1018) THEN DD.R250_1 ELSE NULL END),1) AS COL3
    ...
    FROM
     CIS2.VW_DATA_ALL D
         ...
         (
           ...
           SELECT P.PERIOADA - 1  AS  PERIOADA FROM CIS2.VW_MD_PERIOADA P INNER JOIN CIS2.VW_MD_PERIOADA T ON(P.ANUL=T.ANUL AND P.TIP_PERIOADA=7) 
...
SELECT
  ...
  D.CUATM,
  D.CAPITOL,
  SUM(CASE WHEN D.RIND IN ('240') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R240_1,
  SUM(CASE WHEN D.RIND IN ('240') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R201_2,
  SUM(CASE WHEN D.RIND IN ('240') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R201_3,
  SUM(CASE WHEN D.RIND IN ('250') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R250_1,
  SUM(CASE WHEN D.RIND IN ('250') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R202_2,
  SUM(CASE WHEN D.RIND IN ('250') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R202_3
