...
SELECT
  ...
  R.CUATM,
  MR.CAPITOL,
  SUM(CASE WHEN MR.RIND IN ('240') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R240_1,
  SUM(CASE WHEN MR.RIND IN ('240') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R201_2,
  SUM(CASE WHEN MR.RIND IN ('240') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R201_3,
  SUM(CASE WHEN MR.RIND IN ('250') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R250_1,
  SUM(CASE WHEN MR.RIND IN ('250') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R202_2,
  SUM(CASE WHEN MR.RIND IN ('250') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R202_3
