SELECT 
  ...
  CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('110','111','112','113')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL1)>0 THEN D.CUIIO END))) AS COL1, 
  CIS2.NVAL(SUM ((CASE WHEN D.RIND  IN ('110')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1)ELSE 0 END))) AS COL2, 
  CIS2.NVAL(SUM ((CASE WHEN D.RIND  IN ('111')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1)ELSE 0 END))) AS COL3, 
  CIS2.NVAL(SUM ((CASE WHEN D.RIND  IN ('112')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1)ELSE 0 END))) AS COL4, 
  CIS2.NVAL(SUM ((CASE WHEN D.RIND  IN ('113')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1)ELSE 0 END))) AS COL5, 
  CIS2.NVAL(SUM ((CASE WHEN D.RIND  IN ('120')  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1)ELSE 0 END))) AS COL6 
