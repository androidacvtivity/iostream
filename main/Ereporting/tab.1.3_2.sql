...
COUNT(DISTINCT CASE WHEN D.RIND IN ('1.1.2','1.1.1') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' AND (DD.has_112 + DD.has_111) = 2  AND NVAL(D.COL1) = 1  AND (CC.RIND LIKE '%'|| SUBSTR(D.CAEM2,1,1) ||'%') THEN D.CUIIO END) AS COL1,
