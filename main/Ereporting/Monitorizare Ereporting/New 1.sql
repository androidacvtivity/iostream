SELECT
  ...
  '0' as NUME_SECTIE2,
   ...
   SUM(CASE WHEN D.RIND IN ('1400') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL4) ELSE NULL END)||'~'||R.NR_ROW AS NR_ROW,
  
  --TO_NUMBER(R.NR_ROW) AS NR_ROW,
...
--  ROUND(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1400') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL5) ELSE NULL END)),0) AS COL1
