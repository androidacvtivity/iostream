SELECT
    ...
    FROM CIS2.VW_DATA_ALL D
       ...
       WHERE
        ...
        D.COL31
         HAVING
         SUM (CASE WHEN D.COL31  LIKE ('56%') THEN NVAL(D.COL4) + NVAL(D.COL5) + NVAL(D.COL6) ELSE 0 END ) > 0
...
----        AND
----        
----        SUM (CASE WHEN D.COL31 NOT LIKE ('56%') THEN NVAL(D.COL4) + NVAL(D.COL5) + NVAL(D.COL6) ELSE 0 END ) > 0
