...
D.ORDINE,
D.NUME_ROW,
CASE WHEN (D.COL2 + D.COL3 + D.COL4) = 0 THEN NULL ELSE (D.COL2 + D.COL3 + D.COL4) END   AS COL1,
CASE WHEN (D.COL2) = 0 THEN NULL ELSE (D.COL2) END   AS COL2,
CASE WHEN (D.COL3) = 0 THEN NULL ELSE (D.COL3) END   AS COL3,
CASE WHEN (D.COL4) = 0 THEN NULL ELSE (D.COL4) END   AS COL4
