      ...
      SELECT
        ...
        TR.ORDINE,
        TR.RIND,
        ROUND((SUM(DD.COL2) / 1000 * SUM(CASE WHEN D.RIND = '1.3.1' AND NVAL(D.COL1)>=1 THEN NVAL(D.COL1)  END))/100,1)  AS COL1,
        ROUND((SUM(DD.COL2) / 1000 * SUM(CASE WHEN D.RIND = '1.3.2' AND NVAL(D.COL1)>=1 THEN NVAL(D.COL1)  END))/100,1)  AS COL2,
        ROUND((SUM(DD.COL2) / 1000 * SUM(CASE WHEN D.RIND = '1.3.3' AND NVAL(D.COL1)>=1 THEN NVAL(D.COL1)  END))/100,1)  AS COL3
