...
--acum sunt 25 de coloane in fisierul csv sut parametri   
-- nu modifica nimic in cod - modifica nu mai randurile si adauga coloanele care lipsesc 
  ...
  (
    SELECT 
      ...
      COUNT(DISTINCT CASE WHEN D.RIND IN ('1.5.7') AND NVAL(D.COL1) = 1
          ...
          COUNT(DISTINCT CASE WHEN D.RIND LIKE '1.5%'  AND NVAL(D.COL1) = 1
            AND (TR.RIND LIKE '%'|| SUBSTR(D.CAEM2,1,1) ||'%' OR TR.RIND LIKE '%'|| SUBSTR(D.CAEM2,2,2) ||'%')
