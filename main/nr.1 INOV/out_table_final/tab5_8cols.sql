...
ORDINE,
RIND,
COL1, COL2, COL3, COL4, COL5, COL6, COL7, COL8, COL5, COL6, COL7, COL8, COL6, COL7, COL8
FROM
(
SELECT
  A.NR_TABLE,
...
ORDINE,
RIND,
COL1, COL2, COL3, COL4, COL5, COL6, COL7, COL8, COL5, COL6, COL7, COL8, COL6, COL7, COL8,COL5
FROM
(
SELECT
  A.NR_TABLE,
...
SELECT
 ...
 TR.NR_TABLE,
  ...
  COUNT(DISTINCT CASE WHEN D.RIND IN ('1.5.4') AND NVAL(D.COL1) = 1 AND ( (TR.RIND LIKE '%'|| SUBSTR(D.CAEM2,1,1) ||'%') OR (TR.RIND LIKE '%'|| SUBSTR(D.CAEM2,2,2) ||'%') )  THEN D.CUIIO END) AS COL4,
...
SUM(COL1) + SUM(COL2) + SUM(COL3) + SUM(COL4) + SUM(COL5) + SUM(COL6) + SUM(COL7) AS COL8,
SUM(COL1)  AS COL2,
SUM(COL2)  AS COL3,
SUM(COL3)  AS COL4,
SUM(COL4)  AS COL5,
